...
<property name="reachableAddresses" type="as" access="read"/>
<property name="activeProviderNames" type="as" access="read"/>
...
class Device(DBusInterface):
    def __init__(self, device_id: str):
        super().__init__(name="org.kde.kdeconnect.device")
